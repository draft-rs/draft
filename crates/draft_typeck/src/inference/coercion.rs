...
/// enriched with contextual information (`Cause`, source spans,
...
fn occurs(icx: &mut InferCx, own: Id<TyVar>, t: &Typ) -> bool {
    ...
    match t {
        ...
        it @ Typ::Enum(_, _) => it
            .variants(icx)
            .iter()
            .any(|v| v.fields.iter().any(|f| occurs(icx, own, &f))),
