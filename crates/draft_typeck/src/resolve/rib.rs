...
impl RibsStack {
    ...
    ///
    /// # Parameters
    /// - `span`: The source span of the variable, used for error reporting.
    ...
    ///
    pub fn define(&mut self, span: &Span, name: &String, typ: Typ) {
    ...
    ///
    pub fn lookup(&self, name: &String) -> Option<Typ> {
